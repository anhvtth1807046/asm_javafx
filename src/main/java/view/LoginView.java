...
public class LoginView {
    ...
    public LoginView(MyApplication application) {
    ...
    private void initComponent(){
        ...
        this.labelAccount = new Label("Tài khoản: ");
        this.labelPassword = new Label("Mật khẩu: ");
        this.labelError = new Label("Tài khoản hoặc mật khẩu sai vui lòng thử lại!");
        this.labelError.setFont(Font.font(13));
        this.labelError.setTextFill(Color.RED);
        this.labelError.setVisible(false);

        this.textFieldAccount = new TextField();
        this.textFieldAccount.setPromptText("Tài khoản của ban...");
        this.passwordFieldPassword = new PasswordField();
        this.passwordFieldPassword.setPromptText("Mật khẩu của bạn...");

        this.buttonLogin = new Button("Đăng nhập");
        ...
        this.hyperlinkRegisterAccount = new Hyperlink("Bạn chưa có tài khoản?");
