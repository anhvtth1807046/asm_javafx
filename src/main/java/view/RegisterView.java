...
public class RegisterView {
    ...
    public RegisterView(MyApplication application) {
    ...
    private void initComponent() {
        ...
        this.lblAccount = new Label("Tài khoản: ");
        this.lblPassword = new Label("Mật khẩu: ");
        this.lblPasswordConfirm = new Label("Nhập lại mật khẩu: ");
        this.lblIndentityCard = new Label("Số thẻ căn cước: ");
        this.lblPhone = new Label("Số diện thoại: ");
        this.lblEmail = new Label("Email: ");
        this.lblFullName = new Label("Họ và tên: ");
        this.lblGender = new Label("Giới tính ");
        ...
        this.rbFemale = new RadioButton("Nữ");
        this.rbMale = new RadioButton("Nam");
        ...
        this.btnRegister = new Button("Đăng ký");
        this.btnRegister.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                if (lblError == null){
                    lblError = new Label("Có lỗi xảy ra vui điền đủ các thông tin bên dưới!");
                }
        ...
        this.btnReset = new Button("Làm lại");

        this.hlLogin = new Hyperlink("Quay lại đăng nhập.");
        this.hlLogin.setFont(Font.font(10));
        this.hlLogin.setTextFill(Color.web("#4267B2"));
